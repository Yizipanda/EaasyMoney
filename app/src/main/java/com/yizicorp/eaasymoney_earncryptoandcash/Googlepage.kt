...
class Googlepage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val home = findViewById<TextView>(R.id.gohom)
        val godown = findViewById<Button>(R.id.googdown)


        home.setOnClickListener {
            val rtg = Intent(this,Homepage::class.java)
            startActivity(rtg)
            finishAffinity()
        }
        ...
        godown.setOnClickListener {
            ...
            val grl = Intent(android.content.Intent.ACTION_VIEW)
            grl.data = Uri.parse("https://googleopinionrewards.page.link/share")
            startActivity(grl)
        }
    ...
    private fun ads() {
        ...
        mAdView = findViewById(R.id.adViewgoo)
