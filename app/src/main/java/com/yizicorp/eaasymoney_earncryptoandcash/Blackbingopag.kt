...
class Blackbingopag : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_blackbingopag)

        val gohom = findViewById<TextView>(R.id.gohom)
        val donbb = findViewById<Button>(R.id.bbdom)

ads()

        gohom.setOnClickListener {
            val inn = Intent(this,Homepage::class.java)
            startActivity(inn)
            finishAffinity()
        }

        donbb.setOnClickListener {
            val srl = Intent(android.content.Intent.ACTION_VIEW)
            srl.data = Uri.parse("https://games.skillz.com/game/5638?creative_id=referral_5638")
            startActivity(srl)
        }
    ...
    private fun ads() {
        ...
        mAdView = findViewById(R.id.adViewblack)
