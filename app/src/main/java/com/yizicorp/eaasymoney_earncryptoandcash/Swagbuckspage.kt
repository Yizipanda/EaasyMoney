...
class Swagbuckspage : AppCompatActivity() {

    lateinit var mAdView: AdView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_swagbuckspage)
        ...
        val swagdownload = findViewById<Button>(R.id.swagdown)
        ...
        swagdownload.setOnClickListener {

            val srl = Intent(android.content.Intent.ACTION_VIEW)
            srl.data = Uri.parse("https://www.swagbucks.com/p/register?rb=72097523")
            startActivity(srl)
        }
    ...
    private fun ads2() {
        ...
        mAdView = findViewById(R.id.adViewsag)
    ...
    private fun ads1() {
        ...
        mAdView = findViewById(R.id.adViewhid)
        val adRequest = AdRequest.Builder().build()
        mAdView.loadAd(adRequest)
    ...
    private fun ads() {
        ...
        mAdView = findViewById(R.id.adViewsbu)
        val adRequest = AdRequest.Builder().build()
        mAdView.loadAd(adRequest)
    }
}