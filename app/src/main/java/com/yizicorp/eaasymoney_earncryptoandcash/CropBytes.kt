...
class CropBytes : AppCompatActivity() {

    lateinit var mAdView: AdView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_crop_bytes)
        ...
        val crop6 = findViewById<Button>(R.id.crydom)
    ...
    gohom.setOnClickListener {
        ...
        crop6.setOnClickListener {

            val inh = Intent(android.content.Intent.ACTION_VIEW)
            inh.data = Uri.parse("https://cropbytes.com/invite/5425EA")
            startActivity(inh)
        }
    ...
    private fun ads1() {
        ...
        mAdView = findViewById(R.id.adViewbyt)
    ...
    private fun ads() {
        ...
        mAdView = findViewById(R.id.adViewcrop)
        val adRequest = AdRequest.Builder().build()
        mAdView.loadAd(adRequest)
